...
import kr.or.kosta.mvc.ex1.model.IndexModel;
...
public class ModelFactory {
	...
	public ModelInter getModel(String cmd) {
		...
		if (cmd != null) {
			String path ="C:\\bigdata\\KOSTA\\KOSTA\\Spring\\jsp0222_mybatis_resultMap\\src\\kr\\or\\kosta\\mvc\\ex1\\controller\\classinfo.properties";
			try {
