...
산업공학과 출신이지만 외부 수업으로 IT를 배우고, 거기서 IT와 산업공학과의 융합이 가능하다는 점에서 큰 매력을 느껴 도전하고 있습니다.

특히나 제일 관심있어 하는 분야는 데이터 엔지니어 입니다. 산업공학과의 머신러닝 기법들을 배워왔고, 머신러닝에 필요한 데이터들을 수집 및 저장, 처리하는 데이터 엔지니어에 대해 공부하는것이 제일 재미있습니다. 

최근 관심있어하는 기술은 Hadoop Eco-system입니다. 특히나 그 중에서 관심있어 하는 것은 Kafka입니다. 외부 워크샵 및 강연을 통해 Kafka에 대해 배워나갔습니다. 

하지만 비전공자이다보니 부족한 점도 많습니다. 비전공자로써 부족한 컴퓨터 공학 지식인 컴퓨터 구조, 서버, 네트워크 등은 제가 대학때 수업으로 강의를 들어본 경험이 없습니다. 이러한 부분을 보완하고자 전공서적이나 학습 서적을 통해 계속해서 부족한 부분을 채워나가고 있습니다.

최종 목표는 데이터 분석과 데이터 엔지니어를 융합한 데이터 사이언티스트가 되는 것이 저의 궁극적인 목표입니다.
